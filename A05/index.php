    ...
    <div class="chat-container">
        ...
        <div class="header">
            ...
            <div class="header-icons">
                <!-- Displaying icons for call, vc, more -->
                <?php
        ...
        <div class="input-section">
            <div class="input-icons">
                <!-- Displaying icons beside the typing area -->
                <?php
            ...
            <?php
                echo "<div class='icon send' style='background-image: url(images/" . htmlspecialchars($groupChatData['sendMessage']) . ");'></div>";
            ?>
        </div>
    </div>
</body>
